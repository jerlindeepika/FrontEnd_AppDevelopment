  ...
  return (
    ...
    <div>
      ...
      <Fade right duration={2500}>
            <div><img src={seo} className="aka02"/></div>
          </Fade>
          <div className="notnow">
      <img className="notnow-image" alt="Card Image" src="https://via.placeholder.com/150" />
    ...
    <div className="nottoday">
      <img className="nottoday-image" alt="Card Image" src="https://via.placeholder.com/150" />
    ...
    <div className="nomore">
      <img className="nomore-image" alt="Card Image" src="https://via.placeholder.com/150" />
